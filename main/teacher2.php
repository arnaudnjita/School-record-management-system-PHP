   ...
   <?php require_once ('navbar.php'); ?>
    ...
    <div class="search-btn-div">
        ...
        <div style="text-align:center;">
			         Total Number of Students: (<?php echo $rowcount;?>)
			</div>
        <a href="addstudent2.php"><div class="add-stud-btn">Add student</div></a>
    </div>
    ...
    <div class="table-div">
		...
		<tr>
            ...
            <td><?php echo $row['dob']; ?> </td>
                ...
                <td>
                          <a title="Click to View the teacher" href="viewteacher2.php?id=<?php echo $row  ['id']; ?>">
                             <button class="btn btn-success btn-mini">
                               View
                             </button> 
                           </a>

                           <a title="Click to Edit the teacher" href="editteacher2.php?id=<?php echo $row  ['id']; ?>">
                             <button class="btn btn-success btn-mini">
                               Edit 
                             </button> 
                           </a>

                           <a title="Click to Delete the teacher" href="deleteteacher2.php?id=<?php echo $row  ['id']; ?>">
                             <button class="btn btn-success btn-mini">
                               Delete
                             </button> 
                           </a>
