...
?>
        <form class="reg-div" action="updateTeacher.php" method="post" enctype="multipart/form-data">
            <div class="input-div">
                ...
                <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" placeholder="Date of employment" name="yoe" value="<?php echo $row['yoe'] ?>">
