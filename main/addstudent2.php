...
<body>
    <nav>
        ...
        <div class="admin-divs">
            <div class="admin-div">
                <img src="./assets/admin.png" alt="" height="20px">
                <p>Admin</p>
            </div>
            <div class="admin-div">
                <img src="./assets/logout.png" alt="" height="18px">
                <p><a href="../main/DAC-J2/index.php">Log out</a></p>
            </div>
        </div>
    </nav>
    <?php require_once ('sidnav.php'); ?>
    <div class="big-div">
        <form class="reg-div" action="savestudent2.php" method="post" enctype="multipart/form-data">
            <div class="input-div">
                ...
                <input type="text" placeholder="Place of birth" name="pob">
                <input type="text" placeholder="Matricule" value="DAC-J<?php 
                       $prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,4));?>" name="matricule" readonly Required >
                ...
                <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" placeholder="Admission date" name="doa">
                <input type="text" placeholder="Parent's name" name="parent_name">
                <input type="text" placeholder="Parent's contact" name="parent_phone">
            </div>
            ...
            <div class="btn-div">
                <button id="btn" class="add-stud-btn">Add student</button>
            </div>
        </form>
    </div>
    <script>
