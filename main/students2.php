   ...
   <?php require_once ('navbar.php'); ?>
    ...
    <div class="search-btn-div">
        ...
        <div style="text-align:center;">
               Total Number of Students: <b>(<?php echo $rowcount;?>)</b>
			</div>
    ...
    <div class="table-div">
		...
		<tr>
            ...
            <td><?php echo $row['dob']; ?> </td>
                ...
                <td>
                          <a title="Click to View the Student" href="viewstudent2.php?id=<?php echo $row  ['id']; ?>">
                           ...
                           <a title="Click to Edit the Student" href="editstudent2.php?id=<?php echo $row  ['id']; ?>">
                             <button class="btn btn-success btn-mini">
                           ...
                           <a title="Click to Delete the Student" href="deletestudent2.php?id=<?php echo $row  ['id']; ?>">
                             <button class="btn btn-success btn-mini">
